...
std::optional<SL::Network::ipv6_address>
SL::Network::ipv6_address::from_string(std::string_view string) noexcept
{
...
std::string SL::Network::ipv6_address::to_string() const
{
