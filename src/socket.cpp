...
SL::Network::socket SL::Network::socket::create_tcpv4(io_service& ioSvc)
{
	return socket(local::create_socket(AF_INET, SOCK_STREAM, IPPROTO_TCP, ioSvc.getHandle()));
}

SL::Network::socket SL::Network::socket::create_tcpv6(io_service& ioSvc)
{
	return socket(local::create_socket(AF_INET6, SOCK_STREAM, IPPROTO_TCP, ioSvc.getHandle()));
}

SL::Network::socket SL::Network::socket::create_udpv4(io_service& ioSvc)
{
	return socket(local::create_socket(AF_INET, SOCK_DGRAM, IPPROTO_UDP, ioSvc.getHandle()));
}

SL::Network::socket SL::Network::socket::create_udpv6(io_service& ioSvc)
{
	return socket(local::create_socket(AF_INET6, SOCK_DGRAM, IPPROTO_UDP, ioSvc.getHandle()));
}

SL::Network::socket::socket(socket&& other) noexcept : m_handle(std::exchange(other.m_handle, INVALID_SOCKET)) {}

SL::Network::socket::~socket()
{
...
SL::Network::socket& SL::Network::socket::operator=(socket&& other) noexcept
{
...
SL::Network::ip_endpoint SL::Network::socket::local_endpoint() const {
...
SL::Network::ip_endpoint SL::Network::socket::remote_endpoint() const {
	SOCKADDR_STORAGE sockaddrStorage = { 0 };
	SOCKADDR* sockaddr = reinterpret_cast<SOCKADDR*>(&sockaddrStorage);
	int sockaddrLen = sizeof(sockaddrStorage);
...
void SL::Network::socket::bind(const ip_endpoint& localEndPoint)
{
	SOCKADDR_STORAGE sockaddrStorage = { 0 };
	SOCKADDR* sockaddr = reinterpret_cast<SOCKADDR*>(&sockaddrStorage);
...
void SL::Network::socket::listen()
{
	listen(SOMAXCONN);
}

void SL::Network::socket::listen(std::uint32_t backlog)
{
...
SL::Network::socket_accept_operation SL::Network::socket::accept(socket& acceptingSocket) noexcept
{
	return socket_accept_operation{ *this, acceptingSocket };
}

SL::Network::socket_connect_operation SL::Network::socket::connect(const ip_endpoint& remoteEndPoint) noexcept
{
	return socket_connect_operation{ *this, remoteEndPoint };
}

SL::Network::socket_disconnect_operation SL::Network::socket::disconnect() noexcept
{
	return socket_disconnect_operation(*this);
}

SL::Network::socket_send_operation SL::Network::socket::send(const void* buffer, std::size_t byteCount) noexcept
{
	return socket_send_operation{ *this, buffer, byteCount };
}

SL::Network::socket_recv_operation SL::Network::socket::recv(void* buffer, std::size_t byteCount) noexcept
{
	return socket_recv_operation{ *this, buffer, byteCount };
} 

SL::Network::socket_recv_from_operation SL::Network::socket::recv_from(void* buffer, std::size_t byteCount) noexcept
{
	return socket_recv_from_operation{ *this, buffer, byteCount };
}

SL::Network::socket_send_to_operation SL::Network::socket::send_to(const ip_endpoint& destination, const void* buffer, std::size_t byteCount) noexcept
{
	return socket_send_to_operation{ *this, destination, buffer, byteCount };
}
SL::Network::socket::socket(win32::socket_t handle) noexcept : m_handle(handle) {}
