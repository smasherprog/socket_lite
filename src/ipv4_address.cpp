...
std::optional<SL::Network::ipv4_address>
SL::Network::ipv4_address::from_string(std::string_view string) noexcept
{
...
std::string SL::Network::ipv4_address::to_string() const
{
