...
std::string SL::Network::ipv6_endpoint::to_string() const
{
	std::string result;
	result.push_back('[');
...
std::optional<SL::Network::ipv6_endpoint>
SL::Network::ipv6_endpoint::from_string(std::string_view string) noexcept
{
