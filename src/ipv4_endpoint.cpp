...
std::string SL::Network::ipv4_endpoint::to_string() const
{
...
std::optional<SL::Network::ipv4_endpoint>
SL::Network::ipv4_endpoint::from_string(std::string_view string) noexcept
{
