...
{
    SuccessfullConnect, FailedConnect
};
enum SocketErrors {
    SE_EAGAIN = INT_MIN,
    SE_EWOULDBLOCK,
...
public:
    ISocket() {}
    virtual ~ISocket() {};
    template <Socket_Options SO> auto getsockopt() const {
        return getsockopt_factory_impl<SO>::getsockopt_(handle, this);
    }
