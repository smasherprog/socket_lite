...
#ifdef _WIN32
        void setCompletionHandler(std::shared_ptr<RW_CompletionHandler> &c) { completionhandler = c; }
        std::shared_ptr<RW_CompletionHandler> getCompletionHandler() { return completionhandler; }
#else
