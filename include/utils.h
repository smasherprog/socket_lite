...
#pragma warning(pop)
    ...
    class overlapped_operation : public overlapped {
      public:
        overlapped_operation() : overlapped({0}) {}
        dword_t m_errorCode = 0;
        dword_t m_numberOfBytesTransferred = 0;
        std::experimental::coroutine_handle<> m_awaitingCoroutine = nullptr;
    };
