#ifndef SL_NETWORK_IP4_ADDRESS
#define SL_NETWORK_IP4_ADDRESS
...
namespace SL::Network {
	...
	public:
		...
		constexpr bool is_loopback() const { return m_bytes[0] == 127; }
		...
		constexpr std::weak_ordering operator<=>(ipv4_address const& rhs) const = default;
